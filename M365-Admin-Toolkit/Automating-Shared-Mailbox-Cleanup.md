...
*Location: `Audit-SharedMailboxOU.ps1` lives in `access-profile/`. If you maintain a private tenant-preset copy with your real values baked in, this guide applies to it equally.*
