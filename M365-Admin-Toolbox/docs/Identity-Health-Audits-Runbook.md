...
*Location: all four scripts and this runbook live in the Shared folder, since none of them need a tenant-preset/neutral split (see section 2 below for why). The tenant-preset and vendor-neutral script pairs live in their own tenant-preset and neutral folders respectively.*
