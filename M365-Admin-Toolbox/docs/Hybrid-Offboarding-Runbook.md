...
*Location: this script and runbook live in the Neutral folder. The tenant-preset twin (Offboard-HybridUser.ps1) and its own runbook live in your private tenant-preset folder. Scripts that don't need a tenant-preset/neutral split at all - the identity-health audit scripts - live in a Shared folder alongside both.*
